...
.before_battle_text
	...
	para "Was<...> Sie haben die"
	line "Erweckung gesehen?"

	done

.defeated_text
	ctxt "Wenigstens sind"
	line "wir hier sicher."
...
CastroForest_Trainer_2:
	...
	ctxt "Ich wurde in dem"
	line "Glauben erzogen,"
	para "dass die Wächter"
	line "gut sind."

	para "Wenn sie wirklich"
	line "Wilde sind, dann"
	para "möchte ich nicht"
	line "nach Naljo zurück!"

	done

.before_battle_text
	ctxt "Ich stamme von"
	line "Naljo. Ich fühlte"
	para "mich sicher, bis"
	line "ich erfuhr, dass"
	para "Varaneous einen"
	line "anderen Naljo-aner"
...
CastroForestRoadBlockNPC:
	ctxt "Dies ist ein"
	line "heiliger Bereich."

	para "Zutritt vorerst"
	line "nicht gestattet!"
