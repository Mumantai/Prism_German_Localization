...
EagulouGymB1FGuide:
	ctxt "Dies ist eine "
	line "Erweiterung von "
	cont "Saxifragia Eiland."

	para "Sie waren zu voll,"
...
.before_battle_text
	...
	para "ich esse nichts, "
	line "dann lassen sie "
	cont "mich gehen!"
	done
