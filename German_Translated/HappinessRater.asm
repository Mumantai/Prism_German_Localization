...
.S_tier_text
	ctxt "Es sieht sehr"
	para "glücklich aus!"
	line "Es muss dich sehr"
	cont "gern haben."
	sdone

.A_tier_text
	ctxt "Ich habe den"
	para "Eindruck, dass es"
	line "dir wirklich"
	cont "vertraut."
	done

.B_tier_text
	ctxt "Es verhält sich"
	para "dir gegenüber sehr"
	line "freundlich."
	para "Es muss glücklich"
	cont "sein."
	done

.C_tier_text
	ctxt "Es gewöhnt sich"
	para "langsam an dich."
	line "Es glaubt an dich."
	done

.D_tier_text
	ctxt "Du solltest es"
	para "besser behandeln."
	line "Es hat sich noch"
	para "nicht an dich"
	cont "gewöhnt."
	done
