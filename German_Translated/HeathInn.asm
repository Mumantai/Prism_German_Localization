...
HeathInnNPC:
	ctxt "Dorfheide wird nur"
	line "von einer Familie"
	cont "bevölkert."

	para "Diese Familie lebt"
	line "hier schon seit"
	cont "Jahrhunderten so."

	para "Mein Cousin Rinji"
	line "trainiert unsere"
	para "Kinder im Wald um"
	line "sie zu stärken."

	para "Meine Oma managed"
	line "die Räume hier im"
	cont "Gasthaus und mein"
	para "Bruder betreibt"
	line "den Laden."
	done
