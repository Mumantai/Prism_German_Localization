...
.before_battle_text
	...
	para "nen und die Seneca"
	line "Höhle durchqueren,"
	para "aber niemand hätte"
	line "es wie du gemacht."

	para "Du bist so einzig-"
	line "artig wie eine"
	para "Schneeflocke, die"
	line "in der kalten"
	para "Gebirgsluft tän-"
	line "zelt und taumelt."

	para "Ich bin Yuki, die"
	line "Meisterin aller"
	para "Eis-#mon und"
	line "dein erster Gegner"
	cont "in der Rijon-Liga."

	para "Gib dein Bestes!"
	sdone

.battle_won_text
	ctxt "Was für'n Weg, das"
	line "Eis zu brechen."
	done
