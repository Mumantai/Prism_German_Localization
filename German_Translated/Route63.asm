...
Route63_Trainer_2:
	...
	line "früher voll mit"
	cont "wilden Raupy war."

	para "Aus ihren Fäden"
	line "machte man Seide,"
	para "die zu Kleidung"
	line "verarbeitet wurde."
