...
.select_party_text
	...
	line "#mon, die"
	cont "teilnehmen sollen."
	sdone

.cancel_challenge_text
	ctxt "Willst du wirklich"
	line "jetzt schon gehen?"
	done
...
.text
	ctxt "Es ist eine"
	line "Maschine welches"
	para "die Kämpfe hier"
	line "zusammenstellt!"
	para "Hm? Im Display"
	line "steht was."
	para "<...>"
