...
.before_defeating_gym_text
	...
	line "sicher, was seine"
	para "Firma so macht und"
	line "und ich will es"
	para "auch gar nicht"
	line "wissen."
	done
...
.after_badge_text
	...
	line "deiner #mon."
	para "Nutze ihn, um hier"
	line "schnell wieder zu"
	cont "verschwinden."
	done
