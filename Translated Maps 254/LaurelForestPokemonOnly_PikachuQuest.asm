...
.cant_wait_to_eat_text
	ctxt "Wunderbar!"
	para "Bald gibt's was zu"
	line "futtern, futtern!"
	done
...
.delivered_two_burnt_berries_text
	...
	para "Müll, den ich vor-"
	line "hin gefunden habe."
	prompt
...
.light_ball_substitute_reward_text
	...
	cont "#mon gegeben."
	para "Ah, stimmt!"
	para "Ich habe ja noch"
	line "einen Kugelblitz!"
	prompt

.dont_worry_text
	ctxt "Keine Sorge, ich"
	line "brauch ihn nicht."
