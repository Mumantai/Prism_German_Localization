...
SaxifrageIslandNPC1:
	ctxt "Die Gefangenen in"
	line "diesem Gefängnis"
	para "erzählen die"
	line "wildesten Märchen."
	para "Ein Insasse"
	line "behauptet, er sähe"
	para "Nachts ein Paar"
	line "leuchtende rote"
	cont "Augen im Flur."
	done

SaxifrageIslandNPC2:
	ctxt "Ich warte darauf,"
	line "dass sie meinen"
	cont "Freund entlassen."
	para "Ich werde ewig auf"
	line "ihn warten, oder?"
	done
...
SaxifrageIslandNPC4:
	...
	para "westlich der"
	line "Ruinen auf Route"
	cont "78 ist?"
	para "Geh da nicht rein,"
	line "ohne dich warm"
	cont "anzuziehen!"
	para "Ich bin einmal im"
	line "Badeanzug da rein."
	para "Mein küntlerisch"
	line "schöner Körper hat"
	para "sich davon nie"
	line "wieder erholt."
	para "Was, du glaubst"
	line "mir nicht?"
	para "Du bist auch nicht"
	line "gerade ein"
	cont "Hingucker."
	done
...
.show_ID_text
	...
	line "du mich nicht"
	cont "reinlegen."
	para "Und jetzt komm mal"
	line "schön mit mir mit."
	done
...
.arrested_text
	...
	line "du hier vor hast,"
	para "aber das werden"
	line "wir morgen schon"
	cont "herausfinden."
	sdone
...
.introduction_text
	...
	para "<...>"
	para "Wie ich hier drin"
	line "gelandet bin?"
	para "Nunja <...>"
	para "Nachdem ich hier"
	line "gelandet bin, kam"
	para "Varaneous, das von"
	line "Rot erweckt wurde,"
	para "und erschuf den"
	line "Pfad da hinten."
	para "Rot sagte, dass"
