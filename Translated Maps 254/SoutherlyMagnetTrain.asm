...
SoutherlyMagnetTrainNPC:
	...
	line "hat den Anschluss"
	para "an das Magnetzug-"
	line "netz für Tunod"
	cont "ausgehandelt."
	para "Es hat mehrere"
	line "Jahre gedauert,"
	para "den Unterseetunnel"
	line "zu bauen."
	para "Der Flughafen ist"
	line "natürlich nicht"
	para "erfreut darüber,"
	line "das Gebäude mit"
	para "einem Konkurrenten"
	line "zu teilen."
	para "Ich denke aber, es"
	line "zeigt unser"
	para "Engagement zum"
	line "Umweltschutz."
	para "Im Gegensatz zu"
	line "Naljo, respektie-"
	para "ren wir die Natur"
	line "und reißen sie"
	cont "nicht nieder."
	done
