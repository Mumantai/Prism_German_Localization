...
SoutherlyPokecenterNPC2:
	...
	para "Früher gab es eine"
	line "Brücke dorthin im"
	para "Palmtree Resort,"
	line "aber ein heftiger"
	para "Sturm hat sie vor"
	line "ein paar Jahren"
	cont "zerstört."
	para "Seitdem kann sich"
	line "niemand darüber"
	para "einigen, wer für"
	line "den Wiederaufbau"
	cont "bezahlt."
	done
